...
public class PluginFrame extends javax.swing.JFrame {
    ...
    ITicasPlugin plugin = null;
    ITicasAfterSimulation ticasFrame = null;
    private Section section;
    private Period period;
    private PluginFrame thisFrame;
    private PluginInfo pluginInfo;
//    public boolean IsVisible = false;
    public PluginFrame(final ITicasAfterSimulation ticasFrame) {
        initComponents();
        this.ticasFrame = ticasFrame;
        this.thisFrame = this;
//        this.IsVisible = true;
    ...
    private void checkClose() {
        ...
        if(JOptionPane.showConfirmDialog(rootPane, "Close?"+adding, "Confirm", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            ticasFrame.afterSimulation(thisFrame);
            dispose();
    ...
    public void setPluginInfo(PluginInfo pluginInfo) throws Exception {
        ...
        if(klass == null) {
            ...
            plugin = pm.getPlugin(ITicasPlugin.class);
        } else {
            plugin = (ITicasPlugin)klass.newInstance();
        }

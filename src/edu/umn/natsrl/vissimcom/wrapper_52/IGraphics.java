...
public class IGraphics extends DispatchPtr {
    ...
    * @param AttValue
    **/
    public void setAttValue(String Attribute,boolean newValue2) throws COMException
    {
        put("AttValue", Attribute, newValue2);
    }    
    ...
    * @return void
    **/
    public void Screenshot(String Filename,int resFactor) throws COMException
    {
      
		invokeN("Screenshot", new Object[] {Filename, new Integer(resFactor)});

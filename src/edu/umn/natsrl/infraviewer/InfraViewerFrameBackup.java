...
import edu.umn.natsrl.map.GoogleTileFactoryInfo;
...
public class InfraViewerFrameBackup extends javax.swing.JFrame {
    ...
    public InfraViewerFrameBackup() {
        initComponents();        
        
//        this.jmKit.setTileFactory(GoogleMapsTileProvider.getDefaultTileFactory());        
        
        //TileFactoryInfo tfi = new GoogleTileFactoryInfo (0, 15, 17, 256, true, true, false);
        //this.jmKit.setTileFactory(new DefaultTileFactory(tfi));        
    ...
    private void formComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentResized
        //Rectangle bnd = jmKit.getMainMap().getViewportBounds();
        //System.out.println(bnd.toString());
    }//GEN-LAST:event_formComponentResized
    boolean showAllStation = false;
...
//            System.out.println("--> " + rn.getId() + "("+rn.getStationId()+")");
    ...
    private void findInfraObject() {
        ...
        if (obj == null) {
            JOptionPane.showMessageDialog(rootPane, "Cannot find " + infraId + " from infra (" + infraType + ")");
            return;
        }
    ...
    private void showInfraObjectFromFile() {
        ...
        if (ip == null) {
            JOptionPane.showMessageDialog(rootPane, "Fail to load list");
            return;
        }

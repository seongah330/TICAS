 ...
 */
public class TICASChartLine extends TICASChart implements ChartImpl{
    public TICASChartLine(){
        super();
        init();
    }
    ...
    public void setSpeedData(HashMap<Integer,Boolean> point, HashMap<Integer,Boolean> time, HashMap<Integer,Boolean> bare, 
        ...
        this.setYRange(0,(int)(TICASChartUtil.calculateStep(Maxdata,10)+20));
        setAxisTitle("Time Interval",dataName);
        
        this.AddDataTrace(datas,dataName);
